...
public class AbsenceController {
  ...
  public ResponseEntity<Absence> post(@PathVariable("studentId") long studentId, @RequestBody Absence absence) {
  ...
  public boolean isExcusedJson(@PathVariable("studentId") long studentId, @PathVariable("absenceId") long absenceId) {
    return get(studentId, absenceId).isExcused();
  }

  @GetMapping(value = "{absenceId}/excused", produces = MediaType.TEXT_PLAIN_VALUE)
  public String isExcusedText(@PathVariable("studentId") long studentId, @PathVariable("absenceId") long absenceId) {
